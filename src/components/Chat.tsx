...
function Chat() {
  ...
  return (
    <div className="w-full h-full bg-gray-200 relative overflow-auto overflow-x-hidden chat-dds">
      <h1 className="flex gap-2 items-center w-full h-20 z-10 backdrop-blur-md sticky chat-head  p-5 top-0">
        {" "}
      ...
      <div className="chat-display w-full min-h-6/6 bg-gradient-to-tr mb-40 relative flex flex-col">
        <div className="bgimg w-full bg-red absolute top-0 ">
          <img
            className="w-full"
            src="https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTExL3NtYWxsZGVzaWduY29tcGFueTAxX2FfY3V0ZV9pbGx1c3RyYXRpb25fb2ZfY29tcGFjdF9jaXR5X3ZpZXdfbV8yOWUwZDM5YS02MjI3LTQ4NjktODUwNi0wODIwMjFjN2IxODlfMS5qcGc.jpg"
            alt=""
          />
        </div>
        <div className="msg-disp">
          <Message />
          <Message />
          <Message />
          <Message />
